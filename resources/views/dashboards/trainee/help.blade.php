  ...
  @section('content')
      <div class="flex h-screen">
          ...
          <div class="flex-1 p-8 overflow-y-auto">
              <header class="">
                  <h1 class="text-3xl text-gray-800 font-bold">Welcome to Talent<span class="text-gray-500">Connect</span>
                  </h1>
              ...
              <div class="mt-12 flex justify-around md:flex-row flex-col">
                  ...
                  <div class="mb-12 max-w-[570px] lg:mb-0">
                      <span class="text-gray-800 block mb-4 font-semibold text-xl text-primary">
                          Help Centre
                      </span>
                      <h2
                          class="text-gray-500 mb-6 text-[20px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                          Your Source for Answers
                      </h2>
                      <p class="text-base leading-relaxed text-body-color  mb-9">
                          Our Help Center is here for you around the clock. Whether you have a question, need assistance, or
                          just want to learn more about our services, our team is ready to help 24/7.
                      </p>
                      <div class="mb-8 flex w-full max-w-[370px]">
                          <div
                              class="bg-gray-200 text-gray-600 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                  ...
                  <div class="w-lg px-4 lg:w-1/2 xl:w-5/12 md:pt-16">
                      <div class="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                          ...
                          <form>
                              ...
                              <div>
                                  <button type="submit"
                                      class="w-full bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-full block lg:text-center mt-4">
                                      Send Message
                                  </button>
                              </div>
                          </form>
                          ...
                          <div>
                              ...
                              <span class="absolute -left-10 -bottom-11 z-[-1]">
                                  <svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                                      xmlns="http://www.w3.org/2000/svg">
                                      <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M0 100C0 44.7715 0 0 0 0C55.2285 0 100 44.7715 100 100C100 100 100 100 0 100Z"
                                          fill="#6B7280" transform="rotate(180 50 50)" />
                                  </svg>
                              </span>
                          </div>
                      </div>
