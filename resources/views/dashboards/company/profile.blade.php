        ...
        <div class="flex-1 p-8 overflow-y-auto">
            <div class="">
                ...
                <div class="flex flex-col items-center -mt-20">
                    <img src="{{ asset('storage/' . $company->company_image) }}" class="w-40 h-40
                ...
                <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                    <div class="flex items-center space-x-4 mt-2">
                        <a href="{{ route('company.editProfile', ['id' => $company->id]) }}"
            ...
            <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                ...
                <ul class="mt-2 text-gray-700">
                    <li class="flex border-y py-2">
                        ...
                        <span class="text-gray-700">{{ ucwords($company->company_name) }}</span>
                    </li>
                    <li class="flex border-b py-2">
                        <span class="font-bold w-32">Contact name</span>
                        <span class="text-gray-700">{{ ucwords($company->contact_name) }}</span>
                    </li>
                    <li class="flex border-b py-2">
                        <span class="font-bold w-32">Joined</span>
                        <span class="text-gray-700">{{ ucwords($company->created_at) }}</span>
                    </li>
                    <li class="flex border-b py-2">
                        <span class="font-bold w-32">Mobile</span>
                        <span class="text-gray-700">{{ ucwords($company->phone_number) }}</span>
                    </li>
                    <li class="flex border-b py-2">
